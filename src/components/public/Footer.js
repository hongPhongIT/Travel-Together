      ...
      <div className="container">
        ...
        <div className="foot-icons ">
          <ul className="footer-social-links list-inline list-unstyled">
            <li><a href='' target="_blank" className="foot-icon-bg-1"><i className="fa fa-facebook" /></a></li>
            <li><a href='' target="_blank" className="foot-icon-bg-2"><i className="fa fa-twitter" /></a></li>
            <li><a href='' target="_blank" className="foot-icon-bg-3"><i className="fa fa-instagram" /></a></li>
          </ul>
